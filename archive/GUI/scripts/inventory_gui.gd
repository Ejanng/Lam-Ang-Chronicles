...
@onready var inventory: Inventory = preload("res://scenes/Inventory/resources/Item/playerInventory.tres")
@onready var itemStackGuiClass = preload("res://scenes/GUI/scenes/item_stack_gui.tscn")
